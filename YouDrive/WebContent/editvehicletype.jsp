		...
		<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="row">
					...
					<c:choose>
						<c:when test="${loggedInUser != null && loggedInUser.isAdmin() }">
							<div class="forms">
								<form class="form-signin" method="post" action="VehicleTypeManagement"
									...
									<c:if test="${vehicleType != null }">
										...
										<button type="button" onclick="window.location.replace('managevehicletypes.jsp')" class="btn btn-default btn-lg btn-block">Cancel</button>									
									</c:if>
								</form>
							</div>		
						</c:when>
			...
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
				...
				<div class="list-group">
		            ...
		            <a class="list-group-item active" href="addvehicletype.jsp">Add Vehicle Type</a>
