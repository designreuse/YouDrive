		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<div class="row">
					...
					<h2 class="pull-left">All Vehicles</h2>
					<form class="form-search pull-right" action="VehicleBrowser" method="get">
						<div style="padding-top:18px"class="input-append">
						    ...
						    <input type="hidden" name="redirect" value="browsevehicles.jsp" />
						</div>
					</form>
						...
						<c:otherwise>
							...
							<c:choose>
								<c:when test="${searchTerms != null && !searchTerms.isEmpty() }">
									<c:set var="allVehicles" value="${vehicleMgr.searchVehicles(searchTerms) }" scope="session"/>
								</c:when>
								<c:otherwise>
