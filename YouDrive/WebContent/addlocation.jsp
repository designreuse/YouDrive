		...
		<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="row">
					...
					<c:choose>
						<c:when test="${loggedInUser != null && loggedInUser.isAdmin() }">
							<div class="forms">
								<form class="form-signin" id="addLocation" name="addLocation" action="LocationManagement" method="post">
			...
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
				...
				<div class="list-group">
		            ...
		            <a class="list-group-item active" href="addlocation.jsp">Add Location</a>
